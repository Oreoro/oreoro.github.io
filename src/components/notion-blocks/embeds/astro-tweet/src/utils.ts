...
function getEntities(tweet: TweetBase): Entity[] {
	...
	const entities: Partial<TweetBase["entities"]> = tweet.entities ?? {};
	...
	fixRange(tweet, result, entities.media);
 ...
 */
function fixRange(tweet: TweetBase, entities: EntityWithType[], media?: MediaEntity[] | null) {
